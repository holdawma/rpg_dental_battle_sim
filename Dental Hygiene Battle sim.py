...
""").strip().lower()
                ...
                # Restock Toothpaste Move
                    ...
                    player_mp += 10
                    if player_mp >= player_max_hp:
                        player_mp = player_max_hp
...
|____/ \__,_|\__|\__|_|\___| |_____/|_|_| |_| |_|\__,_|_|\__,_|\__\___/|_|   
    ...
    time.sleep(1.5)
    player_max_hp, player_hp, player_rst, player_dmg, player_max_mp, player_mp = battle(player_max_hp, player_hp, player_rst, player_dmg, player_max_mp, player_mp, "Evil Milkshake", 50, 10, 15, 25)
    print("""PLAYER STATS:
        Max Health: {}
        Resistance: {}
        Damage: {}
    ...
    player_max_hp, player_hp, player_rst, player_dmg, player_max_mp, player_mp = battle(player_max_hp, player_hp, player_rst, player_dmg, player_max_mp, player_mp, "Corrupt Soda", 50, 35, 20, 40)
